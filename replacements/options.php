...
if ( get_site_option( 'initial_db_version' ) < 32453 ) {
	$whitelist_options['writing'] = array();
	$whitelist_options['reading'] = array( 'posts_per_page', 'posts_per_rss', 'rss_use_excerpt', 'show_on_front', 'page_on_front', 'page_for_posts', 'blog_public' );
	$whitelist_options['writing'] = array();
	$whitelist_options['discussion'][] = 'avatar_default';
	$whitelist_options['discussion'][] = 'show_avatars';
	$whitelist_options['discussion'][] = 'avatar_rating';
	if ( show_writing_setting_page() ) {
		$whitelist_options['discussion'][] = 'default_category';
	} else {
		$whitelist_options['general'][] = 'default_category';
	}
	$whitelist_options['discussion'][] = 'default_link_category';
	$whitelist_options['discussion'][] = 'default_post_format';
} else {
	$whitelist_options['general'][] = 'posts_per_page';
	$whitelist_options['general'][] = 'page_on_front';
	$whitelist_options['general'][] = 'page_for_posts';
	$whitelist_options['general'][] = 'blog_public';
}
